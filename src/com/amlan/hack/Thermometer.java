...
public final class Thermometer extends View implements SensorEventListener {
	...
	private static final int centerDegree = 30; // the one in the top center (12 o'clock)
	private static final int minDegrees = -10;
...
//		String title = getTitle();
		...
		canvas.drawTextOnPath(String.format("%.2f",temperatureC)+" \u00B0"+"C", titlePath, 0.0f,0.0f, titlePaint);				
	}
